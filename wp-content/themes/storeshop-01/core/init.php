...
locate_template('/core/settings/wc/wc-product-setting.php', TRUE);
locate_template('/core/settings/wc/wc-product-detail-setting.php', TRUE);
locate_template('/core/settings/wc/wc-checkout-setting.php', TRUE);
