	...
	<div class="agile-sometext py-md-5 py-sm-4 py-3">
		<div class="container">
			...
			<div class="sub-some child-momu mt-4">
				...
				<ul>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay2.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay5.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay1.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay4.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay6.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay3.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay7.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay8.png" alt="">
					</li>
					<li>
						<img src="<?php echo TEMPLATE_URL; ?>/public/images/pay9.png" alt="">
					</li>
				</ul>
			</div>
			<!-- //payment -->
